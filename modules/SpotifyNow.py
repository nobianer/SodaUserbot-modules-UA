...
class SpotifyMod(loader.Module):
    ...
    strings_ua = {
        "need_auth": (
            "<emoji document_id=5312526098750252863>🚫</emoji> <b>Виконай"
            " </b><code>.sauth</code><b> перед виконанням цієї дії.</b>"
        ),
        "on-repeat": (
            "<emoji document_id=5469741319330996757>💫</emoji> <b>Повторення"
            " ввімкнено.</b>"
        ),
        "off-repeat": (
            "<emoji document_id=5472354553527541051>✋</emoji> <b>Повторення"
            " вимкнено.</b>"
        ),
        "skipped": (
            "<emoji document_id=5471978009449731768>👉</emoji> <b>Трек перемкнено.</b>"
        ),
        "err": (
            "<emoji document_id=5312526098750252863>🚫</emoji> <b>Сталася помилка."
            " Убедитесь, что музыка играет!</b>\n<code>{}</code>"
        ),
        "already_authed": (
            "<emoji document_id=5312526098750252863>🚫</emoji> <b>Вже авторизований</b>"
        ),
        "authed": (
            "<emoji document_id=6319076999105087378>🎧</emoji> <b>Успішна"
            " аутентифікація</b>"
        ),
        "playing": "<emoji document_id=6319076999105087378>🎧</emoji> <b>Граю...</b>",
        "back": (
            "<emoji document_id=5469735272017043817>👈</emoji> <b>Перемкнув назад</b>"
        ),
        "paused": "<emoji document_id=5469904794376217131>🤚</emoji> <b>Пауза</b>",
        "deauth": (
            "<emoji document_id=6037460928423791421>🚪</emoji> <b>Авторизацію"
            " скасовано</b>"
        ),
        "restarted": (
            "<emoji document_id=5469735272017043817>👈</emoji> <b>Почав трек"
            " спочатку</b>"
        ),
        "liked": (
            '<emoji document_id=5199727145022134809>❤️</emoji> <b>Поставив "Мені'
            ' подобається" поточному треку</b>'
        ),
        "autobio": (
            "<emoji document_id=6319076999105087378>🎧</emoji> <b>Оновлення біо"
            " ввімкнено {}</b>"
        ),
        "404": (
            "<emoji document_id=5312526098750252863>🚫</emoji> <b>Немає результатів</b>"
        ),
        "playing_track": (
            "<emoji document_id=5212941939053175244>🎧</emoji> <b>{} додано до"
            " черги</b>"
        ),
        "no_music": (
            "<emoji document_id=5312526098750252863>🚫</emoji> <b>Музика не грає!</b>"
        ),
        "_cmd_doc_sfind": "Знайти інформацію про трек",
        "_cmd_doc_sauth": "Перший етап аутентифікації",
        "_cmd_doc_scode": "Другий етап аутентифікації",
        "_cmd_doc_unauth": "Скасувати аутентифікацію",
        "_cmd_doc_sbio": "Ввімкнути автоматичне біо",
        "_cmd_doc_stokrefresh": "Примусове оновлення токена",
        "_cmd_doc_snow": "Показати картку поточного треку",
        "_cls_doc": (
            "Тулкіт для Spotify. Автор ідеї: @fuccsoc. Реалізація: @hikariatama"
        ),
        "currently_on": "Зараз слухаю на",
        "playlist": "Плейлист",
        "owner": "Власник",
        "quality": "Якість",
    }
